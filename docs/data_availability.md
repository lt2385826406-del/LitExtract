...
- Full YOLO annotation label files (bounding box coordinates for ~2,000 figure regions across 1,091 pages) — label files may be available upon request; raw images are not redistributed
