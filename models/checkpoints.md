...
|------|---------|----------|--------------|
| Binary (microstructure vs. other) | 1,684 Ti-alloy figure crops (used for paper-reported results); expanded pool of 3,200 available but not used for manuscript results | 0.91 (validation) | `models/resnet50_micro.pth` |
...
|-----------|---------------|------------|----------------|---------|-----------|
| `Qwen/Qwen2.5-7B-Instruct` | 16 | 32 | 8,192 | 199 papers (Ti + Ni), 5,432 chunks | `models/qwen25_lora/` (not included) |
